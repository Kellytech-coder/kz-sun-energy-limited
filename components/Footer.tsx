    ...
    <footer className="bg-[#F3F3F3] text-black px-4 sm:px-6 md:px-16 py-12 md:py-16">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 md:gap-12">
          ...
          {/* Left */}
          <div>
            <h3 className="font-inter text-xl md:text-2xl font-semibold mb-4 md:mb-6">
              Logo
            </h3>
        ...
        <div className="mt-12 md:mt-16">
          <h1 className="font-inter text-3xl sm:text-5xl md:text-[120px] font-bold leading-tight md:leading-none break-words">
        ...
        {/* Bottom */}
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 font-poppins text-xs sm:text-sm text-gray-700">
