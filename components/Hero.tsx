...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-[520px] md:min-h-[560px] flex flex-col justify-between px-4 sm:px-6 md:px-10 pt-10 md:pt-12 pb-32 md:pb-40 overflow-hidden">
      ...
      <div className="relative z-10 max-w-xl md:max-w-2xl">
        ...
        {/* 🔥 Pill Badge */}
        <div className="mb-4">
          <span className="inline-block font-poppins text-xs sm:text-sm text-white/90 px-5 py-2 rounded-full 
            bg-gradient-to-r from-white/20 to-white/10 backdrop-blur-md border border-white/20 shadow-sm">
            Whole Sale Pricing For Everyone
          </span>
        </div>

        {/* Heading */}
        <h1 className="font-inter text-white text-3xl sm:text-4xl md:text-5xl xl:text-6xl font-bold leading-[1.15] tracking-tight mb-4 md:mb-5">
          Reliable Solar Equipment for Homes & Businesses
        </h1>

        {/* Body */}
        <p className="font-poppins text-white/80 text-sm sm:text-base md:text-[15px] leading-relaxed max-w-md md:max-w-lg mb-6 md:mb-8">
        ...
        <div className="flex flex-col sm:flex-row gap-3 font-poppins">
      ...
      {/* Stats */}
      <div className="relative z-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 border-t border-white/15 mt-10 md:mt-12 font-poppins">
